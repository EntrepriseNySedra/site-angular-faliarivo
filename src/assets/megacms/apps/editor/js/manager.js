document.addEventListener("DOMContentLoaded", function(){
    ...
    MEGA_append("script","text/javascript","/megacms/apps/editor/tinymce/js/tinymce/tinymce.min.js");
    ...
    MEGA_append("script","text/javascript","/megacms/apps/editor/js/interface.js");
}, false);
